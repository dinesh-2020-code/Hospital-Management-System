...
class doctor:
    def __init__(self,root):
        ...
        heading=Label(frame_head,text="HOSPITAL MANAGEMENT SYSTEM",font=("times new roman",15),fg="white",bg="dark blue" ).place(x=10,y=4,height=30)
        ...
        self.bg_home=PhotoImage(file="D:\My Data\python's project\images\project\images\home2.png")
        ...
        self.bg_doctoricon=PhotoImage(file="D:\My Data\python's project\images\project\images\doctoricon.png")
        ...
        self.bg_patienticon=PhotoImage(file="D:\My Data\python's project\images\project\images\patienticon.png")
        ...
        self.bg_appointmenticon=PhotoImage(file="D:\My Data\python's project\images\project\images\calendericon.png")
        ...
        self.bg_admiticon=PhotoImage(file="D:\My Data\python's project\images\project\images\dmiticon.png")
        ...
        self.bg_exiticon=PhotoImage(file="D:\My Data\python's project\images\project\images\exiticon.png")
